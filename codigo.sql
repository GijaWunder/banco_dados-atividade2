...
create table ator(codAtor varchar(3) primary key,
...
('a8', 'Harry Comick Jr.', 'Harry Cornick Jr.', 'USA', 'M', 40, null, null),
...
insert into personagem(codFilme, codAtor, personagem, cachePersonagem) values
('f1', 'a1', 'Mary', 30000),
...
('f16', 'a18', 'Betty', 700000),
('f16', 'a19', 'Bruce', 8000000),
('f17', 'a14', 'Bobby', 400000),
('f17', 'a15', 'Bill', 600000),
